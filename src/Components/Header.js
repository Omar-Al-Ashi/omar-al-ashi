            ...
            <header id="home">
                ...
                <nav id="nav-wrap">
                    ...
                    <ul id="nav" className="nav">
                        ...
                        <li><a className="smoothscroll"
                               href="#publication">Publications</a></li>
                        <li><a className="smoothscroll"
                ...
                <div className="row banner">
                    <div className="banner-text">
                        ...
                        <h3>Front-End Software Developer specializing in Mobile App Development (Android and iOS).
                            I have experience in building web apps and mobile apps, from planning to development to publishing to maintenance.</h3>
                        <hr/>
                        <ul className="social">
                            {networks}
                        </ul>
